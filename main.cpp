...
{   
    ...
    std::cout << "DoubleType divide result=" << static_cast<double>(dt.divide(5.f)) << std::endl << std::endl;
    ...
    std::cout << "New value of dt = (dt * it) / 5.0f + ft = " << static_cast<double>(dt.multiply(it).divide(5.0f).add(ft)) << std::endl;
    ...
    std::cout << "New value of dt = dt / 0 = " << static_cast<float>(dt.divide(0)) << std::endl;
